...
EvaluationSchema.methods.calculateScore = function () {
  ...
  // Ajouter les critères personnalisés s'ils existent
  if (this.otherCriteria && this.otherCriteria.size > 0) {
    for (const score of this.otherCriteria.values()) {
      criteria.push(score);
    }
  }
  ...
  // Note: On ne prend pas encore en compte les auto-évaluations personnalisées pour simplifier
