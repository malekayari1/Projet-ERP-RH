...
router.post("/users", protect, permit("rh", "manager", "directeur"), createUser);
router.put("/users/:id", protect, permit("rh", "manager", "directeur"), updateUser);
router.patch("/users/:id/deactivate", protect, permit("rh", "manager", "directeur"), deactivateUser);
