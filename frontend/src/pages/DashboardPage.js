          ...
          <>
              ...
              <Card elevation={3} sx={cardStyle} onClick={() => navigate('/my-evaluations')}>
                <CardContent>
                  <Box display="flex" alignItems="center" mb={1}>
                    ...
                    <Typography color="textSecondary">Mes évaluations</Typography>
                  </Box>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card elevation={3} sx={cardStyle}>
                <CardContent>
                  <Box display="flex" alignItems="center" mb={1}>
                    <Avatar sx={{ bgcolor: 'success.light', mr: 2 }}><TrophyIcon /></Avatar>
                    <Typography color="textSecondary">Mon score moyen</Typography>
                  </Box>
                  <Typography variant="h4" fontWeight="bold" color="success.main">{stats.averageScore || 0}%</Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} sm={6} md={3}>
              <Card elevation={3} sx={cardStyle}>
                <CardContent>
                  <Box display="flex" alignItems="center" mb={1}>
                    <Avatar sx={{ bgcolor: 'warning.light', mr: 2 }}><NotificationsIcon /></Avatar>
                    <Typography color="textSecondary">Notifications</Typography>
                  </Box>
                  <Typography variant="h4" fontWeight="bold" color="warning.main">{stats.unreadNotifications || 0}</Typography>
                </CardContent>
              </Card>
            </Grid>
            {stats.lastEvaluation && (
              <Grid item xs={12} sm={6} md={3}>
                <Card elevation={3} sx={cardStyle}>
                  <CardContent>
                    <Box display="flex" alignItems="center" mb={1}>
                      <Avatar sx={{ bgcolor: 'info.light', mr: 2 }}><AssessmentIcon /></Avatar>
                      <Typography color="textSecondary">Dernier score</Typography>
                    </Box>
                    <Typography variant="h4" fontWeight="bold">{stats.lastEvaluation.score}%</Typography>
                    <Chip 
                      label={stats.lastEvaluation.result === 'excellent' ? 'Excellent' : 
                             stats.lastEvaluation.result === 'normal' ? 'Satisfaisant' : 'À améliorer'}
                      color={stats.lastEvaluation.result === 'excellent' ? 'success' : 
                             stats.lastEvaluation.result === 'normal' ? 'warning' : 'error'}
                      size="small"
                      sx={{ mt: 1 }}
                    />
                  </CardContent>
