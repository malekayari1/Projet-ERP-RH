      ...
      try {
        ...
        setTimeout(() => {
          const mockEvaluations = [
            {
              _id: '1',
              employee: { _id: 'e1', fullName: 'Jean Dupont' },
              campaign: { _id: 'c1', title: 'Évaluation Annuelle 2023' },
              status: 'pending',
              score: 78,
              finalResult: 'normal',
            ...
            {
              _id: '2',
              employee: { _id: 'e2', fullName: 'Marie Martin' },
              campaign: { _id: 'c1', title: 'Évaluation Annuelle 2023' },
            ...
            {
              _id: '3',
              employee: { _id: 'e3', fullName: 'Pierre Durand' },
              campaign: { _id: 'c1', title: 'Évaluation Annuelle 2023' },
              status: 'validated_rh',
              score: 65,
              finalResult: 'normal',
            ...
            {
              _id: '4',
              employee: { _id: 'e4', fullName: 'Sophie Bernard' },
              campaign: { _id: 'c1', title: 'Évaluation Annuelle 2023' },
              status: 'rejected',
              score: 35,
              finalResult: 'failed',
            ...
            {
              _id: '5',
              employee: { _id: 'e5', fullName: 'Thomas Petit' },
              campaign: { _id: 'c1', title: 'Évaluation Annuelle 2023' },
              status: 'pending',
              score: 0,
              finalResult: null,
          ...
          if (searchTerm) {
            filtered = filtered.filter(evaluationItem =>
              evaluationItem.employee.fullName.toLowerCase().includes(searchTerm.toLowerCase()) ||
              evaluationItem.campaign.title.toLowerCase().includes(searchTerm.toLowerCase())
            );
          }

          if (statusFilter !== 'all') {
            filtered = filtered.filter(evaluationItem => evaluationItem.status === statusFilter);
          }
